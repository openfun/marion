"""Tests for the marion.certificates.utils module"""

from pathlib import Path

from django.conf import settings

from marion.certificates.utils import static_file_fetcher
...
def test_static_file_fetcher(fs):
    ...
    static_file_path = Path(
        f"{settings.BASE_DIR}/marion/certificates/static/{relative_static_file_path}"
    )
